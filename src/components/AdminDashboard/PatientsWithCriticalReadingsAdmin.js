...
const PatientsWithCriticalReadingsAdmin = () => {
  ...
  return (
    <div className="container-fluid mt-3 mb-5">
        <h5 className="title pl-3">Patients with critical readings</h5>   
        <p><small className="pl-3">List of RPM patients with critical readings during the last seven days.</small></p>
                ...
                <div className="card">
                    ...
                    <div className="container text-center">
                     ...
                     <label className="profile-label mt-3">Patient Name : </label>
                        &nbsp;<Link to={{ pathname: "/patientProfile", state: {patientid: pts?.assigned_patient_id?._id}}} className="link">{pts?.assigned_patient_id?.firstname + " "+ pts?.assigned_patient_id?.lastname } </Link> 
                    <br/>
                     ...
                     <div className="row-display">
                        <div>
                            <span><b>Sys</b></span>
                            <p style={{color: 'red'}}>{pts?.telemetaryData?.sys}</p>
                        </div>
